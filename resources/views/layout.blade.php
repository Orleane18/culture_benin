        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    <img
                        src="{{asset('adminlte/img/alex.jpg')}}"
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <li class="user-header text-bg-primary">
                        <img
                            src="{{URL::asset('adminlte/img/alex.jpg')}}"
            ...
            <div class="pt-6 mt-6 border-t border-gray-100">
                ...
                <a href="{{ route('utilisateurs.index') }}" 
                   class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 group transition-all duration-200">
                    <i class="w-5 h-5 mr-3 bi bi-person text-gray-500 group-hover:text-green-600"></i>
                    <span>Utilisateurs</span>
                    <span class="ml-auto text-xs font-medium text-green-600 bg-green-100 px-2 py-1 rounded-full">7</span>
                </a>
                ...
                <a href="{{ route('contenus.index') }}" 
                   class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 group transition-all duration-200">
                    ...
                    <span>Contenus</span>
                    <span class="ml-auto text-xs font-medium text-blue-600 bg-blue-100 px-2 py-1 rounded-full">6</span>
                </a>

                <!-- Media -->
                <a href="{{ route('medias.index') }}" 
                   class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 group transition-all duration-200">
                    <i class="w-5 h-5 mr-3 bi bi-camera-video text-gray-500 group-hover:text-green-600"></i>
                    <span>Médias</span>
                    <span class="ml-auto text-xs font-medium text-purple-600 bg-purple-100 px-2 py-1 rounded-full">39</span>
                </a>
                ...
                <a href="{{ route('langues.index') }}" 
                   class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 group transition-all duration-200">
                    ...
                    <span>Langues</span>
                    <span class="ml-auto text-xs font-medium text-amber-600 bg-amber-100 px-2 py-1 rounded-full">8</span>
                </a>
                ...
                <a href="{{ route('regions.index') }}" 
                   class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 group transition-all duration-200">
                    ...
                    <span>Régions</span>
                    <span class="ml-auto text-xs font-medium text-red-600 bg-red-100 px-2 py-1 rounded-full">10</span>
                </a>
                ...
                <a href="{{ route('commentaires.index') }}" 
                   class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 group transition-all duration-200">
                    ...
                    <span class="ml-auto text-xs font-medium text-indigo-600 bg-indigo-100 px-2 py-1 rounded-full">2</span>
                </a>
            </div>

             <!-- Rôles et Permissions (NOUVEAU) -->
                <div class="pt-6 mt-6 border-t border-gray-100">
                <div class="px-4 mb-2">
                    <span class="text-xs font-semibold tracking-wider text-gray-500 uppercase">Rôles & Permissions</span>
                </div>
                    
                        <a href="{{ route('roles.index') }}" 
                           class="flex items-center px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-100 group transition-all duration-200">
                            <i class="w-4 h-4 mr-2 bi bi-person-badge text-gray-400 group-hover:text-purple-600"></i>
                            <span>Rôles</span>
                            <span class="ml-auto text-xs font-medium text-purple-600 bg-purple-50 px-2 py-0.5 rounded">5</span>
                        </a>
        </nav>
...
<!-- Script pour gérer le toggle du sous-menu -->
<script>
document.addEventListener('DOMContentLoaded', function() {
    const toggleBtn = document.getElementById('roles-permissions-toggle');
    const submenu = document.getElementById('roles-permissions-submenu');
    ...
    if (toggleBtn && submenu) {
        ...
        // Open submenu if current page is in roles/permissions section
        const currentPath = window.location.pathname;
        if (currentPath.includes('/roles') || 
            currentPath.includes('/permissions') || 
            currentPath.includes('/role-permissions')) {
...
<!-- Styles supplémentaires pour le sous-menu -->
<style>
...
/* Hover effect pour les sous-items */
#roles-permissions-submenu a:hover {
    transform: translateX(5px);
    transition: transform 0.2s ease;
}

/* Highlight pour l'item actif */
#roles-permissions-submenu a.active {
    background-color: rgba(147, 51, 234, 0.1);
    color: #7c3aed;
    font-weight: 600;
}

#roles-permissions-submenu a.active i {
    color: #7c3aed;
}

/* Styles pour les badges dans le sous-menu */
#roles-permissions-submenu a span {
    font-size: 10px;
    padding: 2px 6px;
}
</style>
